<div class="navbar">
    ...
    <div class="icon">
        ...
        <li><a href="<?php echo base_url('user/getcart') ?>"><i class="fa-solid fa-cart-shopping"></i></a></li>
        <li><a href="<?php echo base_url('user/orders') ?>"><i class="fa-solid fa-bell"></i></a></li>
