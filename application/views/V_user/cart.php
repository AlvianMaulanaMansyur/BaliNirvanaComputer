...
<div class="row d-flex py-5" style="justify-content: center;">
    ...
    <div class="col-lg-8 col-md-10 col-sm-12 card border shadow-0 mb-3">
        <div class="m-3">
            ...
            <?php foreach ($cart as $key) { ?>
                ...
                <div class="col-lg-3 col-sm-6 d-flex flex-row flex-lg-column flex-xl-row text-nowrap">
                    ...
                    <?php $subtotal += $key['harga_produk'] * $key['qty_produk']; ?>
                    <?php $PPN += PPN * $key['harga_produk'] * $key['qty_produk']; ?>
